...
public class Menu_bible_semuxa extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        novyzavet.setOnClickListener((v -> {
            ...
            startActivity(new Intent(getActivity(), novy_zapaviet2.class));
        }));
        ...
        staryzavet.setOnClickListener((v -> {
            ...
            mLastClickTime = SystemClock.elapsedRealtime();
            startActivity(new Intent(getActivity(), stary_zapaviet2.class));
        }));
            ...
            if (!Objects.requireNonNull(bible_time).equals("")) {
                ...
                if (set.get("zavet") == 1) {
                    if (MainActivity.checkModule_resources(getActivity())) {
                        Intent intent = new Intent(getActivity(), novy_zapaviet2.class);
                    ...
                    if (MainActivity.checkModule_resources(getActivity())) {
                        Intent intent = new Intent(getActivity(), stary_zapaviet2.class);
                        intent.putExtra("kniga", set.get("kniga"));
                        intent.putExtra("glava", set.get("glava"));
                        intent.putExtra("stix", set.get("stix"));
                        intent.putExtra("prodolzyt", true);
        ...
        umovy.setOnClickListener((v -> {
            if (SystemClock.elapsedRealtime() - mLastClickTime < 1000) {
                return;
            }
            mLastClickTime = SystemClock.elapsedRealtime();
            Dialog_Alesya_Semukha semukha = new Dialog_Alesya_Semukha();
