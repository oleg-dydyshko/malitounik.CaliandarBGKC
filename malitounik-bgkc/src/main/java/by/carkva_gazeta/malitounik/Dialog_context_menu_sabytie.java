...
public class Dialog_context_menu_sabytie extends DialogFragment {
    
    private int position;
    private String name;
    private Dialog_context_menu_sabytie_Listener mListener;

    public static Dialog_context_menu_sabytie getInstance(int position, String name) {
        Dialog_context_menu_sabytie Instance = new Dialog_context_menu_sabytie();
    ...
    interface Dialog_context_menu_sabytie_Listener {
    ...
    public void onAttach(@NonNull Context activity) {
        ...
        if (activity instanceof Activity) {
            try {
                mListener = (Dialog_context_menu_sabytie_Listener) activity;
            } catch (ClassCastException e) {
                throw new ClassCastException(activity.toString() + " must implement Dialog_context_menu_sabytie_Listener");
            }
        }
    }
