...
public class stary_zapaviet_sinaidal2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> children40 = new ArrayList<>();
        ArrayList<String> children41 = new ArrayList<>();
        ArrayList<String> children42 = new ArrayList<>();
        ArrayList<String> children43 = new ArrayList<>();
        ArrayList<String> children44 = new ArrayList<>();
        ArrayList<String> children45 = new ArrayList<>();
        ArrayList<String> children46 = new ArrayList<>();
        ArrayList<String> children47 = new ArrayList<>();
        ArrayList<String> children48 = new ArrayList<>();
        ArrayList<String> children49 = new ArrayList<>();
        ArrayList<String> children50 = new ArrayList<>();
        ...
        ExpListAdapterStaryZapavietSinaidal adapter = new ExpListAdapterStaryZapavietSinaidal(this, groups);
        ...
        elvMain.setOnChildClickListener((parent, v, groupPosition, childPosition, id) -> {
            ...
            if (MainActivity.checkModule_resources(this)) {
                try {
                    Intent intent = new Intent(this, Class.forName("by.carkva_gazeta.resources.stary_zapaviet_sinaidal3"));
