...
public class novy_zapaviet2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpListAdapterNovyZapaviet adapter = new ExpListAdapterNovyZapaviet(this, groups);
        ...
        elvMain.setOnChildClickListener((parent, v, groupPosition, childPosition, id) -> {
            ...
            if (MainActivity.checkModule_resources(this)) {
                try {
                    Intent intent = new Intent(this, Class.forName("by.carkva_gazeta.resources.novy_zapaviet3"));
