...
public class Dialog_pdf_error extends DialogFragment {
    
    private String format;

    public static Dialog_pdf_error getInstance(String format) {
        Dialog_pdf_error error = new Dialog_pdf_error();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        format = Objects.requireNonNull(getArguments()).getString("format");
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        textViewZaglavie.setText("ПАМЫЛКА");
        ...
        textView.setText(getString(R.string.pdf_error, format));
