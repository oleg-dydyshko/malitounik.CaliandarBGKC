...
public class psalterNadsana2 extends Fragment implements View.OnClickListener {

    private final Activity activity;

    psalterNadsana2(Activity activity) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.nadsan_pravila2, container, false);
