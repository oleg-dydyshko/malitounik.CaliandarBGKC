...
public class psalterNadsana3 extends Fragment implements View.OnClickListener {
    
    private final Activity activity;

    psalterNadsana3(Activity activity) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.nadsan_pravila3, container, false);
