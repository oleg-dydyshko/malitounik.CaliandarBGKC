        ...
        if (mPerevod == 1) {
            ...
            if (MaranAta_Global_List.getNatatkiSemuxa().size() > 0) {
                for (int i = 0; i < MaranAta_Global_List.getNatatkiSemuxa().size(); i++) {
                    if (MaranAta_Global_List.getNatatkiSemuxa().get(i).get(0).contains(zav) && Integer.valueOf(MaranAta_Global_List.getNatatkiSemuxa().get(i).get(1)) == kniga && Integer.valueOf(MaranAta_Global_List.getNatatkiSemuxa().get(i).get(2)) == glava && Integer.valueOf(MaranAta_Global_List.getNatatkiSemuxa().get(i).get(3)) == position) {
                        SpannableStringBuilder ssb = new SpannableStringBuilder(ea.textView.getText());
        ...
        if (mPerevod == 2) {
            ...
            if (MaranAta_Global_List.getNatatkiSinodal().size() > 0) {
                for (int i = 0; i < MaranAta_Global_List.getNatatkiSinodal().size(); i++) {
                    if (MaranAta_Global_List.getNatatkiSinodal().get(i).get(0).contains(zav) && Integer.valueOf(MaranAta_Global_List.getNatatkiSinodal().get(i).get(1)) == kniga && Integer.valueOf(MaranAta_Global_List.getNatatkiSinodal().get(i).get(2)) == glava && Integer.valueOf(MaranAta_Global_List.getNatatkiSinodal().get(i).get(3)) == position) {
                        SpannableStringBuilder ssb = new SpannableStringBuilder(ea.textView.getText());
                        int nachalo = ssb.length();
