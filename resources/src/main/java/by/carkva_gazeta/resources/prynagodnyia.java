...
public class prynagodnyia extends AppCompatActivity implements View.OnTouchListener, Dialog_font_size.Dialog_font_size_Listener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        akafist.setTextSize(TypedValue.COMPLEX_UNIT_SP, fontBiblia);
        int id = Objects.requireNonNull(getIntent().getExtras()).getInt("prynagodnyiaID", R.raw.prynagodnyia_0);
        try {
        ...
        try {
            title = getIntent().getExtras().getString("prynagodnyia", "");
