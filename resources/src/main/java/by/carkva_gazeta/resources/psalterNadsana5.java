...
public class psalterNadsana5 extends Fragment implements View.OnClickListener {
    
    private final Activity activity;

    psalterNadsana5(Activity activity) {
        this.activity = activity;
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.nadsan_pravila5, container, false);
