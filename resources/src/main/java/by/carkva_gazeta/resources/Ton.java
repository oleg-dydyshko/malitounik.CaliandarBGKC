...
public class Ton extends AppCompatActivity implements View.OnTouchListener, Dialog_font_size.Dialog_font_size_Listener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        akafist.setTextSize(TypedValue.COMPLEX_UNIT_SP, fontBiblia);
        try {
            Resources r = Ton.this.getResources();
            int ton = Objects.requireNonNull(getIntent().getExtras()).getInt("ton", 1);
            boolean ton_nadzelny = getIntent().getExtras().getBoolean("ton_naidzelny", true);
            ...
            String resursOut = builder.toString();
            int n = resursOut.indexOf("<!--ton1n-->");
            int k = resursOut.indexOf("<!--ton1k-->");
            switch (ton) {
                case 1:
            ...
            akafist.setText(MainActivity.fromHtml(resursOut));
