...
public class psalterNadsana4 extends Fragment implements View.OnClickListener {
    
    private final Activity activity;

    psalterNadsana4(Activity activity) {
        this.activity = activity;
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.nadsan_pravila4, container, false);
