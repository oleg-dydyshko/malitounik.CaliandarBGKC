...
public class pesny_taize extends AppCompatActivity implements View.OnTouchListener, Dialog_font_size.Dialog_font_size_Listener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        akafist.setTextSize(TypedValue.COMPLEX_UNIT_SP, fontBiblia);
        title = Objects.requireNonNull(getIntent().getExtras()).getString("pesny", "");
        int pedsny = search_pesny.getPesniaID(title);
        try {
